...
export default function AboutMe() {
    ...
    return (
        <section className="container mx-auto px-4 py-8 text-center">
            <div className="w-48 h-48 sm:w-64 sm:h-64 lg:w-96 lg:h-96 mx-auto mb-4 relative profilePicContainer" onClick={handleImageClick}>
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">Kevin Sullivan, Full Stack Engineer</h1>
